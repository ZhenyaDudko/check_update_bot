...
import ru.tinkoff.edu.java.bot.dto.web.AddLinkRequest;
...
import ru.tinkoff.edu.java.bot.dto.web.RemoveLinkRequest;
...
public class ScrapperClientImpl implements ScrapperClient {
    ...
    private <T> T linksRequestFinish(WebClient.RequestHeadersSpec<?> requestBodySpec, Class<T> tClass)
        throws Throwable {
