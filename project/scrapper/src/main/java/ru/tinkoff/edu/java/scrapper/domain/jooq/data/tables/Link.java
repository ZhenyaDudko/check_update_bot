...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("LAST_UPDATE"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("LOCALTIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>LINK.COMMENT_COUNT</code>.
     */
    public final TableField<LinkRecord, Integer> COMMENT_COUNT = createField(DSL.name("COMMENT_COUNT"), SQLDataType.INTEGER.defaultValue(DSL.field("NULL", SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>LINK.ANSWER_COUNT</code>.
     */
    public final TableField<LinkRecord, Integer> ANSWER_COUNT = createField(DSL.name("ANSWER_COUNT"), SQLDataType.INTEGER.defaultValue(DSL.field("NULL", SQLDataType.INTEGER)), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super Long, ? super String, ? super LocalDateTime, ? super Integer, ? super Integer, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function5<? super Long, ? super String, ? super LocalDateTime, ? super Integer, ? super Integer, ? extends U> from) {
